...
export const en = {
  ...
  defaultContextWindowTip: 'Context fallback for models neither config nor the catalog sizes.',
  defaultMaxTokens: 'defaultMaxTokens',
  defaultMaxTokensTip: 'Output-capability fallback sized the same way.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  // 容量组
  defaultContextWindow: 'defaultContextWindow',
  defaultContextWindowTip: '配置与目录都未声明时的上下文回退值（token）。',
  defaultMaxTokens: 'defaultMaxTokens',
  defaultMaxTokensTip: '同规则下的输出能力回退值（token）。',
